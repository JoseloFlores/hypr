...
mkdir -p "$BAK"
for d in hypr waybar/themes waybar/scripts swaync foot fuzzel; do
...
if [ $FULL -eq 1 ]; then
    ...
    echo "NOTA: no se purgan paquetes (usa 'apt autoremove hyprland waybar' manual si lo quieres)."
fi
echo "Listo."
